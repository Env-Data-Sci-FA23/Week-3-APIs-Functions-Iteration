...
```{r}
#URL for visitation data set:
#https://irmaservices.nps.gov/v3/rest/stats/visitation?unitCodes={UNITCODES}&startMonth={STARTMONTH}&startYear={STARTYEAR}&endMonth={ENDMONTH}&endYear={ENDYEAR}
...
```{r}
ROMO <- unit_visitation(park = "ROMO",startMonth = 11, startYear = 1992, endMonth = 12, endYear = 2021)

EVER <- unit_visitation(park = "EVER",startMonth = 11, startYear = 1992, endMonth = 12, endYear = 2021)

THRO <- unit_visitation(park = "THRO",startMonth = 11, startYear = 1992, endMonth = 12, endYear = 2021)
```
...
```{r}
ROMO2 <- unit_visitation(park = "ROMO", startYear = 1980, endYear = 2021)
EVER2 <- unit_visitation(park = "EVER", startYear = 1980, endYear = 2021)
THRO2 <- unit_visitation(park = "THRO", startYear = 1980, endYear = 2021)
```
...
unit_output_floop <- vector("list", length = length(parks))

for(i in 1:length(parks)){
  
  unit_output_floop[[i]] <-
    unit_visitation(park = parks[i], startYear = 1980, endYear = 2021)
}

multi_parks <- bind_rows(unit_output_floop)
```
...
multi_parks_map <- bind_rows(unit_output_map)
```
