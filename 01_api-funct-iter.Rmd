...
### Exercise #1 (2 points) {style="color: maroon"}
...
packed_data <- GET(url = "https://irmaservices.nps.gov/v3/rest/stats/total/2018");
...
#test <- parkwide_visitation(year = 2018)
...
### Exercise #2 (1 point) {style="color: maroon"}
...
raw_data <- httr::GET(url = "https://irmaservices.nps.gov/v3/rest/stats/total/2020")
  return(final_data)
  }
```
...
raw_data <- httr::GET(url = 
                        ...
                        paste0("https://irmaservices.nps.gov/v3/rest/stats/total/", 2020))
...
### Exercise #3 (1) {style="color: maroon"}
...
### Exercise #4 (1 point) {style="color: maroon"}
...
test <- unit_visitation(unit = "EVER",
                        start_month = "01",
                        start_year = "1992", 
                        end_month = "12",
                        end_year = "2021")

test <- unit_visitation(unit = "THRO",
                        start_month = "01",
                        start_year = "1992", 
                        end_month = "12",
                        end_year = "2021")
...
### Exercise #5 (1 point) {style="color: maroon"}
...
```{r}
unit_visitation <- function(park_code, start_year, end_year, start_month=1, end_month=12) {

unit_visitation("ROMO", 1980, 2021)
unit_visitation("EVER", 1980, 2021)
unit_visitation("THRO", 1980, 2021)
}
```
...
### Exercise #6 (2 points) {style="color: maroon"}
...
# loop
for (park in park_units) {
  output <- unit_visitation(park, 1980, 2021)
...
### Exercise #7 (2 points) {style="color: maroon"}
...
#  map() to run unit_visitation() w arguments
output_list <- map(park_units, ~unit_visitation(.x, 1980, 2021))
