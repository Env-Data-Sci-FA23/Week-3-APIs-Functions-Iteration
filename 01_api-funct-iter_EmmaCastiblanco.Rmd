...
raw_data_1980 # lists 'UTF-8'

# convert content to text
unpacked_data_1980 <- httr::content(raw_data, as = "text", encoding = "UTF-8") 
# parse text from JSON to data frame
final_data_1980 <- jsonlite::fromJSON(unpacked_data)
...
```{r}
raw_data_1999 <- httr::GET(url = "https://irmaservices.nps.gov/v3/rest/stats/total/1980")

raw_data_1999 # lists 'UTF-8'

# convert content to text
unpacked_data_1999 <- httr::content(raw_data, as = "text", encoding = "UTF-8") 
# parse text from JSON to data frame
final_data_1999 <- jsonlite::fromJSON(unpacked_data)

final_data_1999
```

```{r}
raw_data_2018 <- httr::GET(url = "https://irmaservices.nps.gov/v3/rest/stats/total/1980")

raw_data_2018 # lists 'UTF-8'

# convert content to text
unpacked_data_2018 <- httr::content(raw_data, as = "text", encoding = "UTF-8") 
# parse text from JSON to data frame
final_data_2018 <- jsonlite::fromJSON(unpacked_data)
...
packed_data_ROCKY <- httr::GET(url = "https://irmaservices.nps.gov/v3/rest/stats/visitation?unitCodes=ROMO&startMonth=1&startYear=2010&endMonth=12&endYear=2021")

unpacked_data_ROCKY <- httr::content(packed_data_ROCKY, as = "text", encoding = "UTF-8") 

final_data_ROCKY  <- jsonlite::fromJSON(unpacked_data_ROCKY)
...
```{r, eval = F}
unit_visitation <- function(unitCodes="ROMO", startMonth=1, startYear=1992, endMonth=11, endYear=2021){
...
```{r, eval = F}
unit_visitation <- function(unitCodes="ROMO", startMonth=11, startYear=1992, endMonth=12, endYear=2021){
...
test <-unit_visitation(unitCodes="ROMO", startMonth=11, startYear=1992, endMonth=12, endYear=2021)
```

```{r, eval = F}
unit_visitation <- function(unitCodes="EVER", startMonth=11, startYear=1992, endMonth=12, endYear=2021){
...
test_1 <-unit_visitation(unitCodes="EVER", startMonth=11, startYear=1992, endMonth=12, endYear=2021)
```

```{r, eval = F}
unit_visitation <- function(unitCodes="THRO", startMonth=11, startYear=1992, endMonth=12, endYear=2021){
...
test_2 <-unit_visitation(unitCodes="THRO", startMonth=11, startYear=1992, endMonth=12, endYear=2021)
...
```{r, eval = F}
unit_visitation <- function(unitCodes="ROMO", startMonth="1", startYear="1980", endMonth="12", endYear="2021"){
...
```{r, eval = F}
unit_visitation <- function(unitCodes="EVER", startMonth="1", startYear="1980", endMonth="12", endYear="2021"){
...
```{r, eval = F}
unit_visitation <- function(unitCodes="THRO", startMonth="1", startYear="1980", endMonth="12", endYear="2021"){
...
unit_visitation <- function(unitCodes, startMonth="1", startYear="1980", endMonth="12", endYear="2021"){
...
output_floop <- vector("list", length=length(units))

for(i in 1:length(units)) {
  output_floop[[i]] <-unit_visitation(unitCodes= units[i])
  
}

multi_units<- output_floop %>%
  bind_rows()
```
...
output_map <-map(units, ~unit_visitation(unitCodes=.))

multi_map_units<- output_map %>%
  bind_rows()

identical(multi_map_units, multi_units)
```
