...
unpacked_data_1980 <- httr::content(raw_data_1980, as = "text", encoding = "UTF-8") unpacked_data_1999 <- httr::content(raw_data_1999, as = "text", encoding = "UTF-8")
...
```{r}
rockydata_raw <- httr::GET(url = "https://irmaservices.nps.gov/v3/rest/stats/visitation?unitCodes=ROMO&startMonth=01&startYear=2010&endMonth=12&endYear=2021")

rockydata_unpacked <- httr::content(rockydata_raw, as = "text", encoding = "UTF-8")

rockydata_final <- jsonlite::fromJSON(rockydata_unpacked)
rockydata_final
...
test <- unit_visitation(unit = "SHEN", start_month = "01", start_year = "2000",
...
```{r}
romo_pull <- unit_visitation(unit = "ROMO", start_month = "11", start_year = "1992", end_month = "12", end_year = "2021")
romo_pull

ever_pull <- unit_visitation(unit = "EVER", start_month = "11", start_year = "1992", end_month = "12", end_year = "2021")
ever_pull

thro_pull <- unit_visitation(unit = "THRO", start_month = "11", start_year = "1992", end_month = "12", end_year = "2021")
thro_pull
```
...
romo_pull <- unit_visitation(unit = "ROMO", start_year = "1980", end_year = "2021")
ever_pull <- unit_visitation(unit = "EVER", start_year = "1980", end_year = "2021")
thro_pull <- unit_visitation(unit = "THRO", start_year = "1980", end_year = "2021")
...
```{r}
parks_output_map <- parks %>% 
  map(~ unit_visitation(unit = ., start_year = "1980", end_year = "2021"))

identical(output_parks, parks_output_map)
map_multi_parks <- bind_rows(parks_output_map)
