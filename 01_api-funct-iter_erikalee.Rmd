...
output_map <- years %>%
#pipe years vector into the data function
	map(~ parkwide_visitation(year = . ))
	# saying that we want to preform parkwide_visitation on ALL years, . = all)
	
#bind the rows of output
multi_map_years <- output_map %>%
		bind_rows()
```
