...
final_1980 <- jsonlite::fromJSON(unpacked_data_1980)
...
final_1999 <- jsonlite::fromJSON(unpacked_data_1999)
...
final_2018 <- jsonlite::fromJSON(unpacked_data_2018)
...
```{r}
raw_data_ROMO <- httr::GET(url = "https://irmaservices.nps.gov/v3/rest/stats/visitation?unitCodes={ROMO}&startMonth={1}&startYear={2010}&endMonth={12}&endYear={2021}")
unpacked_data_ROMO <- httr::content(raw_data_ROMO, as = "text", encoding = "UTF-8")
final_ROMO <- jsonlite::fromJSON(unpacked_data_ROMO)
...
pull_EVER <- unit_visitation(unit = "EVER",
                             start_month = "11",
                             start_year = "1992",
                             end_month = "12",
                             end_year = "2021")

pull_THRO <- unit_visitation(unit = "THRO",
                             start_month = "11",
                             start_year = "1992",
                             end_month = "12",
                             end_year = "2021")
...
unit_visitation(unit = "ROMO", start_year = "1980", end_year = "2021")

unit_visitation(unit = "EVER", start_year = "1980", end_year = "2021")

unit_visitation(unit = "THRO", start_year = "1980", end_year = "2021")
```
...
parks <- c("THRO", "ROMO", "EVER")

outloop_parks <- vector("list", length = length(parks))
...
multi_parks <- bind_rows(outmap_parks)
